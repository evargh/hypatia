  ...
  public:
	...
	void DoRun()
	{
		...
		ground_stations_file
			<< "0,New-York-Newark,40.717042,-74.003663,0.000000,1334103.172127,-4653693.528901,4138656.197504"
			<< std::endl;
		ground_stations_file
			<< "1,New-York-Newark,40.717042,-74.003663,0.000000,1334103.172127,-4653693.528901,4138656.197504"
			<< std::endl;
		ground_stations_file << "2,Atlanta,33.760000,-84.400000,0.000000,517979.453140,-5282763.124122,3524344.845288"
							 << std::endl;
		ground_stations_file << "3,Atlanta,33.760000,-84.400000,0.000000,517979.453140,-5282763.124122,3524344.845288"
							 << std::endl;
		...
		Ptr<TopologySatelliteNetwork> topology =
			CreateObject<TopologySatelliteNetwork>(basicSimulation, Ipv4ArbiterRoutingHelper());
