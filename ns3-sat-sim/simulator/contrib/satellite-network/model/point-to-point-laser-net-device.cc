...
TypeId PointToPointLaserNetDevice::GetTypeId(void)
{
	static TypeId tid =
		TypeId("ns3::PointToPointLaserNetDevice")
			.SetParent<NetDevice>()
			.SetGroupName("PointToPoint")
			.AddConstructor<PointToPointLaserNetDevice>()
			.AddAttribute(
				"Mtu", "The MAC-level Maximum Transmission Unit", UintegerValue(DEFAULT_MTU),
				MakeUintegerAccessor(&PointToPointLaserNetDevice::SetMtu, &PointToPointLaserNetDevice::GetMtu),
				MakeUintegerChecker<uint16_t>())
			.AddAttribute("Address", "The MAC address of this device.",
						  Mac48AddressValue(Mac48Address("ff:ff:ff:ff:ff:ff")),
						  MakeMac48AddressAccessor(&PointToPointLaserNetDevice::m_address), MakeMac48AddressChecker())
			.AddAttribute("DataRate", "The default data rate for point to point links",
						  DataRateValue(DataRate("32768b/s")), MakeDataRateAccessor(&PointToPointLaserNetDevice::m_bps),
						  MakeDataRateChecker())
			...
			.AddAttribute("InterframeGap", "The time to wait between packet (frame) transmissions",
						  TimeValue(Seconds(0.0)), MakeTimeAccessor(&PointToPointLaserNetDevice::m_tInterframeGap),
						  MakeTimeChecker())
...
void PointToPointLaserNetDevice::AddHeader(Ptr<Packet> p, uint16_t protocolNumber)
{
...
bool PointToPointLaserNetDevice::ProcessHeader(Ptr<Packet> p, uint16_t &param)
{
...
void PointToPointLaserNetDevice::DoDispose()
{
	NS_LOG_FUNCTION(this);
	m_node = 0;
	m_channel = 0;
...
void PointToPointLaserNetDevice::SetDataRate(DataRate bps)
{
	NS_LOG_FUNCTION(this);
	m_bps = bps;
}

void PointToPointLaserNetDevice::SetInterframeGap(Time t)
{
	NS_LOG_FUNCTION(this << t.GetSeconds());
	m_tInterframeGap = t;
}

bool PointToPointLaserNetDevice::TransmitStart(Ptr<Packet> p)
{
...
void PointToPointLaserNetDevice::TransmitComplete(void)
{
	NS_LOG_FUNCTION(this);
...
bool PointToPointLaserNetDevice::Attach(Ptr<PointToPointLaserChannel> ch)
{
...
void PointToPointLaserNetDevice::SetQueue(Ptr<Queue<Packet>> q)
{
	NS_LOG_FUNCTION(this << q);
	m_queue = q;
}

void PointToPointLaserNetDevice::SetReceiveErrorModel(Ptr<ErrorModel> em)
{
	NS_LOG_FUNCTION(this << em);
	m_receiveErrorModel = em;
}

void PointToPointLaserNetDevice::Receive(Ptr<Packet> packet)
{
...
Ptr<Queue<Packet>> PointToPointLaserNetDevice::GetQueue(void) const
{
	NS_LOG_FUNCTION(this);
	return m_queue;
}

void PointToPointLaserNetDevice::NotifyLinkUp(void)
{
	NS_LOG_FUNCTION(this);
	m_linkUp = true;
...
void PointToPointLaserNetDevice::SetIfIndex(const uint32_t index)
{
	NS_LOG_FUNCTION(this);
	m_ifIndex = index;
}

uint32_t PointToPointLaserNetDevice::GetIfIndex(void) const
{
	return m_ifIndex;
}

Ptr<Channel> PointToPointLaserNetDevice::GetChannel(void) const
{
	return m_channel;
}
...
void PointToPointLaserNetDevice::SetAddress(Address address)
{
	NS_LOG_FUNCTION(this << address);
	m_address = Mac48Address::ConvertFrom(address);
}

Address PointToPointLaserNetDevice::GetAddress(void) const
{
	return m_address;
}

void PointToPointLaserNetDevice::SetDestinationNode(Ptr<Node> node)
{
	NS_LOG_FUNCTION(this << node);
	m_destination_node = node;
}

Ptr<Node> PointToPointLaserNetDevice::GetDestinationNode(void) const
{
	return m_destination_node;
}

bool PointToPointLaserNetDevice::IsLinkUp(void) const
{
	NS_LOG_FUNCTION(this);
	return m_linkUp;
}

void PointToPointLaserNetDevice::AddLinkChangeCallback(Callback<void> callback)
{
	NS_LOG_FUNCTION(this);
...
//
bool PointToPointLaserNetDevice::IsBroadcast(void) const
{
	NS_LOG_FUNCTION(this);
	return true;
}
...
//
Address PointToPointLaserNetDevice::GetBroadcast(void) const
{
	NS_LOG_FUNCTION(this);
	return Mac48Address("ff:ff:ff:ff:ff:ff");
}

bool PointToPointLaserNetDevice::IsMulticast(void) const
{
	NS_LOG_FUNCTION(this);
	return true;
}

Address PointToPointLaserNetDevice::GetMulticast(Ipv4Address multicastGroup) const
{
	NS_LOG_FUNCTION(this);
	return Mac48Address("01:00:5e:00:00:00");
}

Address PointToPointLaserNetDevice::GetMulticast(Ipv6Address addr) const
{
	NS_LOG_FUNCTION(this << addr);
	return Mac48Address("33:33:00:00:00:00");
}

bool PointToPointLaserNetDevice::IsPointToPoint(void) const
{
	NS_LOG_FUNCTION(this);
	return true;
}

bool PointToPointLaserNetDevice::IsBridge(void) const
{
	NS_LOG_FUNCTION(this);
	return false;
}

bool PointToPointLaserNetDevice::Send(Ptr<Packet> packet, const Address &dest, uint16_t protocolNumber)
{
...
bool PointToPointLaserNetDevice::SendFrom(Ptr<Packet> packet, const Address &source, const Address &dest,
...
Ptr<Node> PointToPointLaserNetDevice::GetNode(void) const
{
	return m_node;
}

void PointToPointLaserNetDevice::SetNode(Ptr<Node> node)
{
	NS_LOG_FUNCTION(this);
	m_node = node;
}

bool PointToPointLaserNetDevice::NeedsArp(void) const
{
	NS_LOG_FUNCTION(this);
	return false;
}

void PointToPointLaserNetDevice::SetReceiveCallback(NetDevice::ReceiveCallback cb)
{
	m_rxCallback = cb;
}

void PointToPointLaserNetDevice::SetPromiscReceiveCallback(NetDevice::PromiscReceiveCallback cb)
{
	m_promiscCallback = cb;
}

bool PointToPointLaserNetDevice::SupportsSendFrom(void) const
{
	NS_LOG_FUNCTION(this);
	return false;
}

void PointToPointLaserNetDevice::DoMpiReceive(Ptr<Packet> p)
{
	NS_LOG_FUNCTION(this << p);
	Receive(p);
}

Address PointToPointLaserNetDevice::GetRemote(void) const
{
	NS_LOG_FUNCTION(this);
...
uint32_t PointToPointLaserNetDevice::GetRemoteIf(void) const
{
	NS_LOG_FUNCTION(this);
	NS_ASSERT(m_channel->GetNDevices() == 2);
	for (std::size_t i = 0; i < m_channel->GetNDevices(); ++i)
...
bool PointToPointLaserNetDevice::SetMtu(uint16_t mtu)
{
...
uint16_t PointToPointLaserNetDevice::GetMtu(void) const
{
	NS_LOG_FUNCTION(this);
	return m_mtu;
}

uint16_t PointToPointLaserNetDevice::PppToEther(uint16_t proto)
{
...
uint16_t PointToPointLaserNetDevice::EtherToPpp(uint16_t proto)
{
	NS_LOG_FUNCTION_NOARGS();
	switch (proto)
	{
...
void PointToPointLaserNetDevice::EnableUtilizationTracking(int64_t interval_ns)
{
...
void PointToPointLaserNetDevice::TrackUtilization(bool next_state_is_on)
{
...
const std::vector<double> &PointToPointLaserNetDevice::FinalizeUtilization()
{
