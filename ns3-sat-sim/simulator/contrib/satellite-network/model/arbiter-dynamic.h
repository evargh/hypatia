...
#ifndef ARBITER_DYNAMIC_H
#define ARBITER_DYNAMIC_H
...
class ArbiterDynamic : public ArbiterSatnet
{
public:
    ...
    // In refactored code, there could be an "ArbiterDynamic" superclass that requires inheritors to define how forwarding state should be mutated.
...
private:
    ...
    double ValidateForwardHeuristic(
        int32_t source_node_id,
        int32_t target_node_id,
