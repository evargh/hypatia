...
#ifndef IPV4_DHPB_ARBITER_ROUTING_H
#define IPV4_DHPB_ARBITER_ROUTING_H
 ...
 *  can.
 */
class Ipv4DhpbArbiterRouting : public Ipv4RoutingProtocol
{
public:
	static TypeId GetTypeId(void);

	Ipv4DhpbArbiterRouting();
	virtual ~Ipv4DhpbArbiterRouting();
	...
	void SetArbiter(Ptr<ArbiterDhpb> arbiter);
...
#endif /* IPV4_DHPB_ARBITER_ROUTING_H */
