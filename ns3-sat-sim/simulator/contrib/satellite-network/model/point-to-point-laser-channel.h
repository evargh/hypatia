...
class PointToPointLaserChannel : public Channel
{
  public:
	 ...
	 */
	virtual bool TransmitStart(Ptr<const Packet> p, Ptr<PointToPointLaserNetDevice> src, Ptr<Node> node_other_end,
							   Time txTime);
  ...
  protected:
	 ...
	 */
	typedef void (*TxRxAnimationCallback)(Ptr<const Packet> packet, Ptr<NetDevice> txDevice, Ptr<NetDevice> rxDevice,
