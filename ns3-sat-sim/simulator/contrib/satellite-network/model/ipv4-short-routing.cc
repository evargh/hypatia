...
NS_LOG_COMPONENT_DEFINE("Ipv4ShortRouting");

NS_OBJECT_ENSURE_REGISTERED(Ipv4ShortRouting);
...
Ipv4ShortRouting::Ipv4ShortRouting() : m_ipv4(0)
{
...
Ipv4ShortRouting::~Ipv4ShortRouting()
{
	NS_LOG_FUNCTION(this);
}

void Ipv4ShortRouting::NotifyInterfaceUp(uint32_t i)
{
...
void Ipv4ShortRouting::NotifyInterfaceDown(uint32_t i)
{
	throw std::runtime_error("Interfaces are not permitted to go down.");
}

void Ipv4ShortRouting::NotifyAddAddress(uint32_t interface, Ipv4InterfaceAddress address)
{
...
void Ipv4ShortRouting::NotifyRemoveAddress(uint32_t interface, Ipv4InterfaceAddress address)
{
	if (m_ipv4->IsUp(interface))
	{
...
void Ipv4ShortRouting::SetIpv4(Ptr<Ipv4> ipv4)
{
...
void Ipv4ShortRouting::PrintRoutingTable(Ptr<OutputStreamWrapper> stream, Time::Unit unit) const
{
	std::ostream *os = stream->GetStream();
	*os << m_arbiter->StringReprOfForwardingState();
}

void Ipv4ShortRouting::SetArbiter(Ptr<Arbiter> arbiter)
{
	m_arbiter = arbiter;
}

Ptr<Arbiter> Ipv4ShortRouting::GetArbiter()
{
	return m_arbiter;
}
