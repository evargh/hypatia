...
// TODO: change this to L1 instead of L2, and replicate everything
// if everything gets worse, then there's hope
												  ...
												  int16_t base_y)
{
	...
	// return static_cast<int32_t>(x_dist) + static_cast<int32_t>(y_dist);
