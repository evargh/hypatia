...
#include "dhpb-laser-helper.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("DhpbPointToPointLaserHelper");

DhpbPointToPointLaserHelper::DhpbPointToPointLaserHelper ()
{
  m_queueFactory.SetTypeId ("ns3::DropTailQueue<Packet>");
  m_deviceFactory.SetTypeId ("ns3::DhpbPointToPointLaserNetDevice");
...
void 
DhpbPointToPointLaserHelper::SetQueue (std::string type,
...
void 
DhpbPointToPointLaserHelper::SetDeviceAttribute (std::string n1, const AttributeValue &v1)
{
  m_deviceFactory.Set (n1, v1);
}

void 
DhpbPointToPointLaserHelper::SetChannelAttribute (std::string n1, const AttributeValue &v1)
{
...
NetDeviceContainer 
DhpbPointToPointLaserHelper::Install (NodeContainer c)
{
  NS_ASSERT (c.GetN () == 2);
...
NetDeviceContainer 
DhpbPointToPointLaserHelper::Install (Ptr<Node> a, Ptr<Node> b)
{
  ...
  Ptr<DhpbPointToPointLaserNetDevice> devA = m_deviceFactory.Create<DhpbPointToPointLaserNetDevice> ();
  devA->SetAddress (Mac48Address::Allocate ());
  devA->SetDestinationNode(b);
  a->AddDevice (devA);
  Ptr<Queue<Packet> > queueA = m_queueFactory.Create<Queue<Packet> > ();
  devA->SetQueue (queueA);
  Ptr<DhpbPointToPointLaserNetDevice> devB = m_deviceFactory.Create<DhpbPointToPointLaserNetDevice> ();
